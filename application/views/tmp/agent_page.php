...
<div class="label-head">ยอดคงค้าง</div> : <div class="label-body"><?php echo number_format($user_info['balance'],2,'.',',').(($user_info['balance']>=0) ? '':' <span style="font-size:10px;color:red;">(ยอดนี้ต้องจ่ายให้เอเย่นต์)</span>'); ?></div><br>
